# Adapted from https://github.com/venkatesh-thiru/Deep-Harmonization/blob/main/training/models/AttenUNet/AUNet.py
...
if __name__ == '__main__':
    ...
    model = UNet(in_channels=7, out_channels=6, depth=5, spatial_attention="modified", growth_factor=6,
